.PHONY: help install lint typecheck test analyze plots clean

help:
	@echo "make install / lint / typecheck / test - quality gates"
	@echo "make analyze  - run synthetic Pile-of-Law analytics"
...
analyze: ; uv run pol analyze
plots: ; uv run pol plots
clean:
